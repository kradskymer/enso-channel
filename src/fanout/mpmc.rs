//! Multi-publisher, multi-consumer (MPMC) lossless fanout channel.
//!
//! This is the fixed-fanout, LMAX/Disruptor-style topology where each consumer
//! observes every published item and publishers are gated by the slowest consumer.
...
/// Creates a bounded shared MPMC channel.
///
...
/// The sending half of a shared MPMC channel.
///
/// This type is `Clone`.
#[derive(Clone)]
